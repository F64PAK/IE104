        ...
        <div className='background'>
            <nav className= "navbar navbar-expand-lg navbar-transparent header">
                <a className="navbar-brand codelord" href="/">
                    <span className="code code">Learn</span> <span className="lord lord">IT</span>
                </a>
                ...
                <Row className="HomeStart">
                    <Col className='Limit'>
                        <h2 className="Title title">
                            Learn <span style={{ color: "#21B573" }}>IT</span>
                            <br />
                            Code your dreams
                        </h2>
            ...
            <Container className='popular'>
                ...
                <div className='popularline1' style={{ gap: "60px" }}>
                <div className="cybersec">
                        <div className="group-introduce">
                            ...
                            <Button className="button-base" href="/overview">
                ...
                <Row className='howcodelordworks'>                    
                    <p>
                        <div className='koho-font'>
                            <span className='How' id = "aboutus">Learn <span className="lord lord">IT</span> hoạt động như thế nào?</span>
                        </div>
                        <div classname ="poppins-font" style={{position: 'relative', left: 850, top: -70,fontSize : '28px', textAlign:'left', width:'800px'}}>
                            <span className="code code" >Learn</span> 
                            <span className="lord lord" >IT</span>
